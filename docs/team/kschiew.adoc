...
*** Wrote additional tests for existing features to increase coverage (Pull requests https://github.com/AY1920S2-CS2103T-W17-1/main/pull/315[#36])
** Documentation:
...
https://github.com/kschiew/ped/issues/1[#1] https://github.com/kschiew/ped/issues/2[#2] https://github.com/kschiew/ped/issues/3[#3] https://github.com/kschiew/ped/issues/4[$#4]
** Tools:
