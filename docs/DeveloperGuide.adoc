...
[[play]] Play View (Play)::
Enters the play view (mode) of FlashSpeed. In this mode, users will be able to take advantage of the smarter review system to revise/memorise their flashcards.
...
* Not as appealing UI.
* Not friendly for fast typist to execute commands/tasks.
