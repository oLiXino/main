...
|`* * *` |user |show all cards in a deck |remove decks that I no longer need
...
2.  FlashSpeed shows a list of decks
3.  User chooses a deck and requests to list all cards in that deck
4.  FlashSpeed shows a list of all cards in the deck
5.  User requests to delete a specific card in the deck
6.  FlashSpeed deletes the card
+
Use case ends.
...
+
[none]
** 5a1. FlashSpeed shows an error message.
+
