...
You can get the link to this user guide in a new window by typing `help`
in the input box and pressing Enter. +
Format: `help`

==== Exiting the program : `exit`

You can exit FlashSpeed by typing `exit` in the input box and pressing Enter. +
Format: `exit`
...
You can do so by typing `reset` in the input and pressing Enter. +
Format: `reset`
