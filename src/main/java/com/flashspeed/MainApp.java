...
import com.flashspeed.storage.UserPrefsStorage;
import com.flashspeed.ui.Ui;
import com.flashspeed.ui.UiManager;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing FlashSpeed ]===========================");
        super.init();
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting FlashSpeed " + MainApp.VERSION);
        ui.start(primaryStage);
    }

    @Override
    public void stop() {
        logger.info("============================ [ Stopping FlashSpeed ] =============================");
        try {
