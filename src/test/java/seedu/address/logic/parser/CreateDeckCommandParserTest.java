...
import static seedu.address.testutil.Deckdeck.AMY;
import static seedu.address.testutil.Deckdeck.BOB;
...
public class CreateDeckCommandParserTest {
    ...
    public void parse_compulsoryFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, CreateDeckCommand.MESSAGE_USAGE);
